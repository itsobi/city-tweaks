...
export async function POST(req: Request) {
  try {
    ...
    const { object } = await generateObject({
      ...
      - flag: if the city is outside of the United States, the flag will be the country's flag. Go to Wikipedia to find the country's flag and return the URL of the image. If the city is in the United States, the flag will be this: https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Flag_of_the_United_States_%28DoS_ECA_Color_Standard%29.svg/250px-Flag_of_the_United_States_%28DoS_ECA_Color_Standard%29.svg.png
      `,
    });
